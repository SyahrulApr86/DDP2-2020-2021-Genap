...
public class Mahasiswa {
    ...
    private void kunjungiTempat(String namaTempat){
        ...
        if (input.nextLine().equalsIgnoreCase("ya")) {
            switch (t.getClass().getSimpleName()) {
                case "Gedung":
                    Gedung g = (Gedung) t;
                    System.out.printf("Di Gedung %s, kamu bisa Belajar. List semua ruangan: \n%s\n", g.getNama(), Arrays.toString(g.listSemuaRuangan()));
                    break;
            
                case "LabKomputer":
                    System.out.println("Di LabKomputer ini, kamu bisa Gunakan Komputer.");
                    break;
    ...
    private void rekapKunjungan(){
        ...
        for (String namaTempat : listTempatDikunjungi) {
            System.out.println(namaTempat);
        }
    }
